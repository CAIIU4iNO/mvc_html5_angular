package com.java.mvcHtml5Angular.mvc.jdbc;
...
import com.java.mvcHtml5Angular.mvc.bean.DBLog;
import com.java.mvcHtml5Angular.mvc.bean.User;
...
public class JDBCExample {
    ...
    public boolean insertLog(DBLog log){
        ...
        final String INSERT_SQL = "INSERT INTO LOG (LOGSTRING) VALUE(?)";
